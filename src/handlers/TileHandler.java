...
public class TileHandler {
    ...
    private void createTiles() {
        ...
        roads.add(ROAD_1 = new Tile(getSprite(8,0),id++,"Road 1"));
        roads.add(ROAD_2 = new Tile(SpriteDirection.getRotataedImg(getSprite(8,0),90),id++,"Road 2"));

        roadsC.add(ROADC_1 = new Tile(getSprite(7,0),id++,"Road corner 1"));
        roadsC.add(ROADC_2 = new Tile(SpriteDirection.getRotataedImg(getSprite(7,0),90),id++,"Road corner 2"));
        roadsC.add(ROADC_3 = new Tile(SpriteDirection.getRotataedImg(getSprite(7,0),180),id++,"Road corner 3"));
        roadsC.add(ROADC_4 = new Tile(SpriteDirection.getRotataedImg(getSprite(7,0),270),id++,"Road corner 4"));
